...
Let's look at an example for the small multiple horizon graph example, providing a sort of "hover" for the time series.

```javascript
{% include_relative example0-interaction.js %}
```
---
<svg id='svg0' width='900' height='500'></svg>
<script type='text/javascript' src="example0-horizon.js"></script>
<script type='text/javascript' src="example0-sm-plot.js"></script>
<script type='text/javascript' src="example0-axes.js"></script>
<script type='text/javascript' src="example0-interaction.js"></script>
